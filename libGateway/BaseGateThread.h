#ifndef _GATETHREAD_H_
#define _GATETHREAD_H_
...
namespace Util
{
	...
	/************************************************************************/
	class BaseGateway;
	class GATE_API BaseGateThread : public CRefCounter
	{
	public:
		//构造
		BaseGateThread(BaseGateway* pGateway = 0);

		//析构
		virtual ~BaseGateThread();
