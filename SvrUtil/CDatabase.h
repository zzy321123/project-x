...
{		
	...
	/* 数据库操作基类封装                                                   */
	/************************************************************************/
	class UTIL_API CDatabase : public CRefCounter
	{
	public:
		//DB查询结果集
		class UTIL_API QueryResult : public CRefCounter
		{
		public:
			//构造
			QueryResult();
		...
		//DB连接对象
		class UTIL_API DBConn : public CRefCounter
		{
		public:
			//默认构造
	...
	typedef CDatabase::DBConn CDBConn;
}
#endif //_DATABASE_H_
