...
namespace Util
{
	...
	Bool CDiskFile::Open(const AString& sFile, OpenType eOpen)
	{
		Close();
	...
	Bool CDiskFile::WriteCodeType(CodeType eType)
	{
	...
	Int64 CDiskFile::Read(void* pData, Int64 iSize)
	{
	...
	Int64 CDiskFile::ReadLine(void* pData, Int64 iBufSize, UChar cSeparate)
	{
		Int64 iRead = 0;
		UChar cRead = 0;
	...
	Bool CDiskFile::IsEndPos()
	{
		return Tell() == m_iFileSize;
	}

	Int64 CDiskFile::Write(const void* pData, Int64 iSize, Bool bFlush)
	{
		if (pData && m_pFile && iSize)
		{
	...
	Bool  CDiskFile::Chsize(Int64 iSize)
	{
	...
	Int64 CDiskFile::Seek(Int64 iOffset, SeekPos ePos)
	{
		if (m_pFile)
		{
