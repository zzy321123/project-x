...
namespace Util
{
	...
	/* 0MQ分布式消息队列操作封装                                            */
	/************************************************************************/
	class UTIL_API CZmq : public CRefCounter
	{
	protected:
		//构造
		CZmq();
	...
	public:
		...
		//发送数据(基于协议发送)
		virtual Bool   SendProtocol(CProtocol* pProto, Int32 iFlag = 0);

		//接收数据(基于协议接收)
		virtual Bool   RecvProtocol(CProtocol*& pProto, Int32 iFlag = 0);
